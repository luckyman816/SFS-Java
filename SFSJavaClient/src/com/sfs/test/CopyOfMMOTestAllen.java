...
public class CopyOfMMOTestAllen {
	  ...
	  public static void main(String args[]) {
          ...
          sfs.addEventListener(SFSEvent.LOGIN, new IEventListener() {
  			...
  			public void dispatch(BaseEvent event) throws SFSException {
  		        ...
  		        params2.putUtfString("rn", "jetset.vip");
  		        params2.putInt("inst",-1);
  		        
  		        sfs.send(new ExtensionRequest("user.rj", params2)); 
...
/*  		        try {
  		        ...
  		        ISFSObject params3 = new SFSObject();
  		        params3.putUtfString("rn", "jetset.turtle");
  		        params3.putInt("inst",-1);
  		        
  		        sfs.send(new ExtensionRequest("user.rj", params3));  */
  			}
  		  });
          ...
          sfs.addEventListener(SFSEvent.ROOM_JOIN, new IEventListener() {
			...
			public void dispatch(BaseEvent evt) throws SFSException {
				...
				roomName = ((Room) evt.getArguments().get("room")).getName();
          ...
          sfs.addEventListener(SFSEvent.PRIVATE_MESSAGE, new IEventListener() {
			...
			public void dispatch(BaseEvent arg0) throws SFSException {
			 System.out.println("Public message received: " + arg0.getArguments());				
			}
          });          
          ...
          sfs.addEventListener(SFSEvent.USER_COUNT_CHANGE, new IEventListener() {
			...
			public void dispatch(BaseEvent paramBaseEvent) throws SFSException {
				System.out.println("USER_COUNT_CHANGE: " + paramBaseEvent.getArguments());
			}          
          });
          ...
          sfs.addEventListener(SFSEvent.USER_ENTER_ROOM, new IEventListener() {
			...
			@Override
			public void dispatch(BaseEvent paramBaseEvent) throws SFSException {
				System.out.println("USER_ENTER_ROOM: " + paramBaseEvent.getArguments());
			}          
          });
          ...
          sfs.addEventListener(SFSEvent.USER_EXIT_ROOM, new IEventListener() {
			...
			@Override
			public void dispatch(BaseEvent paramBaseEvent) throws SFSException {
				System.out.println("USER_EXIT_ROOM: " + paramBaseEvent.getArguments());
			}          
          });              
